...
public class Medicamentos extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregarMiembro.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iagregar = new Intent(Medicamentos.this, AgregarMiembro.class);
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                Medicamentos.this, R.layout.formato_fila, cursor, from, to);
